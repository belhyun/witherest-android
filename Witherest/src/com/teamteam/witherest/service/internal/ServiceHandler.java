...
public class ServiceHandler extends Handler {
	...
	public void handleMessage(Message msg) {
		...
		if (obj.requestType >= 0 && obj.requestType < 100) {
			...
			categoryServiceCallback
					.onCategoryServiceCallback((BaseResponseObject) msg.obj);
		}
		else if (obj.requestType >= 300 && obj.requestType < 400) {
			roomServiceCallback
					.onRoomServiceCallback((BaseResponseObject) msg.obj);
		}
		else if (obj.requestType >= 400 && obj.requestType < 500) {
			articleServiceCallback
					.onArticleServiceCallback((BaseResponseObject) msg.obj);
		}
	}
	...
	public void setCategoryServiceCallback(
			CategoryServiceCallback categoryServiceCallback) {
