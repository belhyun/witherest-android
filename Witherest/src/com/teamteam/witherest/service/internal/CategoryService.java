...
public class CategoryService extends Service{
	...
	public void getAllCagetoryRoomCount(){
		Map<String, String> paramMap = new HashMap<String, String>();
		paramMap.put(REQUEST_TYPE_STRING,String.valueOf(Service.REQUEST_TYPE_GET_ALL_CATEGORIES_ROOMCOUNT));
		sendGet(GET_ALL_CATEGORIES_ROOMCOUNT_URL, paramMap);
	}
