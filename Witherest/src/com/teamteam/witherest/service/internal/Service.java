...
public class Service {
	...
	/*맵으로 된 파라미터를 ArrayList<NameValuePair>로 변환해 반환.*/
	...
	public void finishedBackgroundProcess(String requsetUrl,String responseText, String requestCode) {
		...
		if (CommonUtils.isNullOrEmpty(responseText)){
			obj = new BaseResponseObject(ConnectionErrorHandler.COMMON_ERROR, null, CommonUtils.str2int(requestCode));
		}
			...
			if (obj == null){
				obj = new BaseResponseObject(ConnectionErrorHandler.PARSING_ERROR,null,CommonUtils.str2int(requestCode));
			}
		}
