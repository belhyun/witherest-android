...
public class ConnectionErrorHandler implements IErrorHandler {
	
	private Context context;
	private ErrorTransaction errorTransaction;
	
	public ConnectionErrorHandler(Context context, ErrorTransaction errorTransaction){
