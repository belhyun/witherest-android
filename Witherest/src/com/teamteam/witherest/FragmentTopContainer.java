...
public class FragmentTopContainer extends Fragment implements UserServiceCallback{
        ...
        mQuickAction.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {			
			public void onItemClick(QuickAction source, int pos, int actionId) {				
				...
				if (actionId == ID_ADD) {
					...
					Intent i = new Intent(mActivity, ActivitySignup.class);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (getActivity() instanceof ActivityCheckRoomList){
			...
			int categoryId = ((ActivityCheckRoomList)getActivity()).mCategoryId;
