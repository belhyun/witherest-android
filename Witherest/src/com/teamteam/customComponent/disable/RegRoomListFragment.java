...
import com.teamteam.witherest.ActivityRoomDetail;
...
public class RegRoomListFragment extends ListFragment {
private static final String KEY_CONTENT = "Fragment:Content";
	...
	public static RegRoomListFragment newInstance(String title, int page, int listType){
		RegRoomListFragment fragment = new RegRoomListFragment();
	...
	public void setRoomListObject(CategoryRoomListResponseObject object, int listType){
		...
		setListAdapter(new PopRoomListFragmentAdapter(getActivity(),
					R.layout.fragment_reg_room_list_item, mRoomListResponse, imageLoader));	
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		fragmentView= inflater.inflate(R.layout.fragment_reg_room_list, null);
		return fragmentView;
	...
	public class PopRoomListFragmentAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageView roomImage = (ImageView)convertView.findViewById(R.id.reg_list_image);
			
			TextView roomTitle = (TextView)convertView.findViewById(R.id.reg_list_title_textview);
			TextView roomPurpose = (TextView)convertView.findViewById(R.id.reg_list_purpose_textview);
			TextView roomTerm = (TextView)convertView.findViewById(R.id.reg_list_term_textview);
			TextView rooJoinState = (TextView)convertView.findViewById(R.id.reg_list_joincount_textview);
			...
			convertView.findViewById(R.id.reg_list_contaniner).setOnClickListener(new View.OnClickListener() {
